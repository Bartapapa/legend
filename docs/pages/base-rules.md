...
Choose or roll a <b>Drive</b>, which gives you an additional way of [checking](https://bartapapa.github.io/legend/base-rules#advancement).
1. Wealth - when you recuperate a named treasure from somewhere dangerous.
2. Secrets - when you learn the answer to one of the world's mysteries.
3. Wildsong - when you set foot in a place that hasn't been seen in a century.
4. Heroism - when you do the right thing, even though you'll suffer for it.
5. Adventure - when you do the dangerous thing, even though you'll suffer for it.
6. Glory - when you show that, indeed, you are an actual badass.
7. Follower - when you accomplish a mission in your superior's name.
8. Chaos - when you break natural or social orders.
...
<b>Skills</b> are special areas of expertise of your character. When you do something that needs special training, is particularly technical, or needs a good grasp of knowledge, you'll roll with disadvantage. If you have a skill that could work contextually, then you roll normally. At character creation, your failed career is your only skill. You can get more by [advancing](https://bartapapa.github.io/legend/base-rules#advancement).
...
Some tools have <b>Traits</b>, which give a bit more info on how it can be used. It can be <i>Treasure</i> or <i>Bright</i>, for example. Here are a list of common traits and their effects.
...
***
## Exploration, Reactions and Resting
...
* <b>Skill:</b> To check a skill, you must have rolled a natural 1 when using a skill or learned something esoteric in regards to that skill.
...
*  Is a skill is checked, you can gain an <b>Expertise</b> in it.
